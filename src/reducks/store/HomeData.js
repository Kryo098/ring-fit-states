...
export const Data = () => {
  ...
  backpressTotalCount = 0;
  bowpressTotalCount = 0;
  flutterkickTotalCount = 0;
  frontpressTotalCount = 0;
  hipliftTotalCount = 0;
  kneeliftTotalCount = 0;
  kneeliftcomboTotalCount = 0;
  kneetochestTotalCount = 0;
  legraiseTotalCount = 0;
  legscissorsTotalCount = 0;
  mountainclimberTotalCount = 0;
  opencloselegraiseTotalCount = 0;
  overheadarmspinTotalCount = 0;
  overheadarmtwistTotalCount = 0;
  overheadbendTotalCount = 0;
  overheadhipshakeTotalCount = 0;
  overheadlungetwistTotalCount = 0;
  overheadpressTotalCount = 0;
  overheadsquatTotalCount = 0;
  overheadsidebendTotalCount = 0;
  pendulumbendTotalCount = 0;
  ringraisecomboTotalCount = 0;
  plankTotalCount = 0;
  russiantwistTotalCount = 0;
  seatedforwardpressTotalCount = 0;
  seatedringraiseTotalCount = 0;
  shoulderpressTotalCount = 0;
  sidestepTotalCount = 0;
  squatTotalCount = 0;
  standingtwistTotalCount = 0;
  thighpressTotalCount = 0;
  tricepkickbackTotalCount = 0;
  widesquatTotalCount = 0;
  backpressTodayCount = 0;
  bowpressTodayCount = 0;
  flutterkickTodayCount = 0;
  frontpressTodayCount = 0;
  hipliftTodayCount = 0;
  kneeliftTodayCount = 0;
  kneeliftcomboTodayCount = 0;
  kneetochestTodayCount = 0;
  legraiseTodayCount = 0;
  legscissorsTodayCount = 0;
  mountainclimberTodayCount = 0;
  opencloselegraiseTodayCount = 0;
  overheadarmspinTodayCount = 0;
  overheadarmtwistTodayCount = 0;
  overheadbendTodayCount = 0;
  overheadhipshakeTodayCount = 0;
  overheadlungetwistTodayCount = 0;
  overheadpressTodayCount = 0;
  overheadsquatTodayCount = 0;
  overheadsidebendTodayCount = 0;
  pendulumbendTodayCount = 0;
  ringraisecomboTodayCount = 0;
  plankTodayCount = 0;
  russiantwistTodayCount = 0;
  seatedforwardpressTodayCount = 0;
  seatedringraiseTodayCount = 0;
  shoulderpressTodayCount = 0;
  sidestepTodayCount = 0;
  squatTodayCount = 0;
  standingtwistTodayCount = 0;
  thighpressTodayCount = 0;
  tricepkickbackTodayCount = 0;
  widesquatTodayCount = 0;
  ...
  if (typeof mountainclimber[0].day === "string") {
    Object.keys(mountainclimber).forEach((a) => {
      mountainclimber[a].day = Number(
        mountainclimber[a].day.replace(/\//g, "")
      );
    });
  }
  if (typeof opencloselegraise[0].day === "string") {
    Object.keys(opencloselegraise).forEach((a) => {
      opencloselegraise[a].day = Number(
        opencloselegraise[a].day.replace(/\//g, "")
      );
    });
  }
  if (typeof overheadarmspin[0].day === "string") {
    Object.keys(overheadarmspin).forEach((a) => {
      overheadarmspin[a].day = Number(
        overheadarmspin[a].day.replace(/\//g, "")
      );
    });
  }
  if (typeof overheadarmtwist[0].day === "string") {
    Object.keys(overheadarmtwist).forEach((a) => {
      overheadarmtwist[a].day = Number(
        overheadarmtwist[a].day.replace(/\//g, "")
      );
    });
  }
  ...
  if (typeof overheadhipshake[0].day === "string") {
    Object.keys(overheadhipshake).forEach((a) => {
      overheadhipshake[a].day = Number(
        overheadhipshake[a].day.replace(/\//g, "")
      );
    });
  }
  if (typeof overheadlungetwist[0].day === "string") {
    Object.keys(overheadlungetwist).forEach((a) => {
      overheadlungetwist[a].day = Number(
        overheadlungetwist[a].day.replace(/\//g, "")
      );
    });
  }
  ...
  if (typeof overheadsidebend[0].day === "string") {
    Object.keys(overheadsidebend).forEach((a) => {
      overheadsidebend[a].day = Number(
        overheadsidebend[a].day.replace(/\//g, "")
      );
    });
  }
  ...
  if (typeof seatedforwardpress[0].day === "string") {
    Object.keys(seatedforwardpress).forEach((a) => {
      seatedforwardpress[a].day = Number(
        seatedforwardpress[a].day.replace(/\//g, "")
      );
    });
  }
  if (typeof seatedringraise[0].day === "string") {
    Object.keys(seatedringraise).forEach((a) => {
      seatedringraise[a].day = Number(
        seatedringraise[a].day.replace(/\//g, "")
      );
    });
  }
  ...
  const opencloselegraisefilledtoday = opencloselegraise.filter(
    (filledtoday) => {
      return filledtoday.day === today;
    }
  );
  ...
  const overheadlungetwistfilledtoday = overheadlungetwist.filter(
    (filledtoday) => {
      return filledtoday.day === today;
    }
  );
  ...
  const seatedforwardpressfilledtoday = seatedforwardpress.filter(
    (filledtoday) => {
      return filledtoday.day === today;
    }
  );
  ...
  return { datas: data, todaydatas: todaydata };
};
