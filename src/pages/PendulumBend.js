  ...
  return (
    <div className="App">
      <Paper elevation={4} className={classes.titlecard}>
        <img src={PendulumBendIcon} alt="icon" className={classes.icon}></img>
        <p className={classes.sbtitle}>Pendulum Bend</p>
        <h2 className={classes.title}>ベントオーバー</h2>
      ...
      <PendulumBendChart work="PendulumBend" />
    </div>
  );
};
