  ...
  return (
    <div className="App">
      <Paper elevation={4} className={classes.titlecard}>
        <img src={SeatedRingRaiseIcon} alt="icon" className={classes.icon}></img>
        <p className={classes.sbtitle}>Seated Ring Raise</p>
        <h2 className={classes.title}>リングアゲアゲ</h2>
      ...
      <SeatedRingRaiseChart work="SeatedRingRaise" />
      <HomeMenuItem />
    </div>
  );
};
