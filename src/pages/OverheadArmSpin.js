  ...
  return (
    <div className={classes.app}>
      <Paper elevation={4} className={classes.titlecard}>
        <img src={OverheadArmSpinIcon} alt="icon" className={classes.icon}></img>
        <p className={classes.sbtitle}>Overhead Arm Spin</p>
        <h2 className={classes.title}>ぐるぐるアーム</h2>
      ...
      <OverheadArmSpinChart work="OverheadArmSpin" />
      <HomeMenuItem />
    </div>
  );
};
