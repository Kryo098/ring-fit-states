  ...
  return (
    <div className={classes.app}>
      <Paper elevation={4} className={classes.titlecard}>
        <img src={OverheadPressIcon} alt="icon" className={classes.icon}></img>
        <p className={classes.sbtitle}>Overhead Press</p>
        <h2 className={classes.title}>バンザイプッシュ</h2>
      ...
      <OverheadPressChart work="OverheadPress" />
      <HomeMenuItem />
    </div>
  );
};
