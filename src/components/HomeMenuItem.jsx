  ...
  const menus = [
    {
      ...
      id: "BackPress",
      value: "/BackPress",
      icon:(<img height="75" src={BackPressIcon} alt="icon"></img>),
    },
    {
      func: selectwork,
      label: "リングアロー",
      id: "BowPress",
      value: "/BowPress",
      icon:(<img height="75" src={BowPressIcon} alt="icon"></img>),
    },
    {
      func: selectwork,
      label: "バタバタレッグ",
      id: "FlutterKick",
      value: "/FlutterKick",
      icon:(<img height="75" src={FlutterKickIcon} alt="icon"></img>),
    },
    {
      func: selectwork,
      label: "サゲテプッシュ",
      id: "FrontPress",
      value: "/FrontPress",
      icon:(<img height="75" src={FrontPressIcon} alt="icon"></img>),
    },
    { 
      func: selectwork,
      label: "ヒップリフト",
      id: "HipLift",
      value: "/HipLift",
      icon:(<img height="75" src={HipLiftIcon} alt="icon"></img>),
    },
    {
      func: selectwork,
      label: "モモアゲコンボ",
      id: "KneeLiftCombo",
      value: "/KneeLiftCombo",
      icon:(<img height="75" src={KneeLiftComboIcon} alt="icon"></img>),
    ...
    id: "KneeLift",
    value: "/KneeLift",
    icon:(<img height="75" src={kneeLiftIcon} alt="icon"></img>),
    },
    {
      func: selectwork,
      label: "ニートゥーチェスト",
      id: "KneetoChest",
      value: "/KneetoChest",
      icon:(<img height="75" src={KneetoChestIcon} alt="icon"></img>),
    },
    { 
    func: selectwork,
    label: "レッグレイズ",
    id: "LegRaise",
    value: "/LegRaise",
    icon:(<img height="75" src={LegRaiseIcon} alt="icon"></img>),
    }, 
    {
      func: selectwork,
      label: "ハサミレッグ",
      id: "LegScissors",
      value: "/LegScissors",
      icon:(<img height="75" src={LegScissorsIcon} alt="icon"></img>),
    },
    {
      func: selectwork,
      label: "マウンテンクライマー",
      ...
      icon:(<img height="75" src={MountainClimberIcon} alt="icon"></img>),
    },
  {
    func: selectwork,
    label: "アシパカパカ",
    ...
    icon:(<img height="75" src={OpenCloseLegRaiseIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "グルグルアーム",
    ...
    icon:(<img height="75" src={OverheadArmSpinIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "アームツイスト",
    ...
    icon:(<img height="75" src={OverheadArmTwistIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "バンザイモーニング",
    id: "OverheadBend",
    value: "/OverheadBend",
    icon:(<img height="75" src={OverheadBendIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "バンザイコシフリ",
    ...
    icon:(<img height="75" src={OverheadHipShakeIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "ワイドスクワット",
    id: "WideSquat",
    value: "/WideSquat",
    icon:(<img height="75" src={WideSquatIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "モモデプッシュ",
    id: "ThighPress",
    value: "/ThighPress",
    icon:(<img height="75" src={ThighPressIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "トライセプス",
    ...
    icon:(<img height="75" src={TricepKickbackIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "スクワット",
    id: "Squat",
    value: "/Squat",
    icon:(<img height="75" src={SquatIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "スワイショウ",
    id: "StandingTwist",
    value: "/StandingTwist",
    icon:(<img height="75" src={StandingTwistIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "サイドステップ",
    id: "SideStep",
    value: "/SideStep",
    icon:(<img height="75" src={SideStepIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "カタニプッシュ",
    id: "ShoulderPress",
    value: "/ShoulderPress",
    icon:(<img height="75" src={ShoulderPressIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "リングアゲサゲ",
    ...
    icon:(<img height="75" src={SeatedRingRaiseIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "マエニプッシュ",
    ...
    icon:(<img height="75" src={SeatedForwardPressIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "ロシアンツイスト",
    id: "RussianTwist",
    value: "/RussianTwist",
    icon:(<img height="75" src={RussianTwistIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "アゲサゲコンボ",
    ...
    icon:(<img height="75" src={RingRaiseComboIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "プランク",
    id: "Plank",
    value: "/Plank",
    icon:(<img height="75" src={PlankIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "ベントオーバー",
    id: "PendulumBend",
    value: "/PendulumBend",
    icon:(<img height="75" src={PendulumBendIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "バンザイスクワット",
    id: "OverheadSquat",
    value: "/OverheadSquat",
    icon:(<img height="75" src={OverheadSquatIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "バンザイサイドベント",
    ...
    icon:(<img height="75" src={OverheadSideBendIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "バンザイプッシュ",
    id: "OverheadPress",
    value: "/OverheadPress",
    icon:(<img height="75" src={OverheadPressIcon} alt="icon"></img>),
  },
  {
    func: selectwork,
    label: "バンザイツイスト",
    ...
    icon:(<img height="75" src={OverheadLungeTwistIcon} alt="icon"></img>),
  },
  ]
  return(
